...
| `.claude/standards/client/coding-principles.md`, `code-style-and-layout.md`, `naming-convention.md` | Whenever you write C#, including an `Assets/Editor/**` build script. |
